...
public class SinchService extends Service implements CallClientListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Sinch_Apps.sinchClient.addSinchClientListener(new SinchClientListener() {
            public void onClientStarted(SinchClient client) {
                callClient=client.getCallClient();
                callClient.addCallClientListener(SinchService.this);
                Sinch_Apps.callClient=callClient;
        ...
        if(!Sinch_Apps.sinchClient.isStarted())
            Sinch_Apps.sinchClient.start();
        return START_STICKY;
    }
